...
{
    __m512i impl_param_0 = _mm512_load_si512((__m512i*)param_0.data());
    __m512i impl_param_1 = _mm512_load_si512((__m512i*)param_1.data());

    __m512i m_ret = _mm512_div_epi8(impl_param_0, impl_param_1);

    _mm512_store_si512((__m512i*)ret.data(), m_ret);
...
TEST(SVML_intrinsics__m512i, test_mm512_div_epi8) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],div((typename Vector64epi8::value_type)param_1[i], (typename Vector64epi8::value_type)param_2[i]).quot) << "Input:"  << ";" <<param_1[i] << ";" <<param_2[i];
            }
}
...
TEST(SVML_intrinsics__m512i, test_mm512_div_epi16) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],div((typename Vector32epi16::value_type)param_1[i], (typename Vector32epi16::value_type)param_2[i]).quot) << "Input:"  << ";" <<param_1[i] << ";" <<param_2[i];
            }
}
...
TEST(SVML_intrinsics__m512i, test_mm512_div_epi32) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],div((typename Vector16epi32::value_type)param_1[i], (typename Vector16epi32::value_type)param_2[i]).quot) << "Input:"  << ";" <<param_1[i] << ";" <<param_2[i];
            }
}
...
TEST(SVML_intrinsics__m512i, test_mm512_div_epi64) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],div((typename Vector8epi64::value_type)param_1[i], (typename Vector8epi64::value_type)param_2[i]).quot) << "Input:"  << ";" <<param_1[i] << ";" <<param_2[i];
            }
}
...
TEST(SVML_intrinsics__m512i, test_mm512_div_epu8) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],div((typename Vector64epu8::value_type)param_1[i], (typename Vector64epu8::value_type)param_2[i]).quot) << "Input:"  << ";" <<param_1[i] << ";" <<param_2[i];
            }
}
...
TEST(SVML_intrinsics__m512i, test_mm512_div_epu16) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],div((typename Vector32epu16::value_type)param_1[i], (typename Vector32epu16::value_type)param_2[i]).quot) << "Input:"  << ";" <<param_1[i] << ";" <<param_2[i];
            }
}
...
TEST(SVML_intrinsics__m512i, test_mm512_div_epu32) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],div((typename Vector16epu32::value_type)param_1[i], (typename Vector16epu32::value_type)param_2[i]).quot) << "Input:"  << ";" <<param_1[i] << ";" <<param_2[i];
            }
}
...
TEST(SVML_intrinsics__m512i, test_mm512_div_epu64) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],div((typename Vector8epu64::value_type)param_1[i], (typename Vector8epu64::value_type)param_2[i]).quot) << "Input:"  << ";" <<param_1[i] << ";" <<param_2[i];
            }
}
...
__declspec(noinline) void helper__mm512_mask_div_epi32(Vector16epi32 &ret, const Vector16epi32 &param_0, const std::int16_t  &param_1, const Vector16epi32 &param_2, const Vector16epi32 &param_3)
{
    ...
    __m512i impl_param_2 = _mm512_load_si512((__m512i*)param_2.data());
    __m512i impl_param_3 = _mm512_load_si512((__m512i*)param_3.data());
...
TEST(SVML_intrinsics__m512i, test_mm512_rem_epi8) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],rem((typename Vector64epi8::value_type)param_1[i], (typename Vector64epi8::value_type)param_2[i])) << "Input:"  << ";" <<param_1[i] << ";" <<param_2[i];
            }
}
...
TEST(SVML_intrinsics__m512i, test_mm512_rem_epi16) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],rem((typename Vector32epi16::value_type)param_1[i], (typename Vector32epi16::value_type)param_2[i])) << "Input:"  << ";" <<param_1[i] << ";" <<param_2[i];
            }
}
...
TEST(SVML_intrinsics__m512i, test_mm512_rem_epi32) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],rem((typename Vector16epi32::value_type)param_1[i], (typename Vector16epi32::value_type)param_2[i])) << "Input:"  << ";" <<param_1[i] << ";" <<param_2[i];
            }
}
...
TEST(SVML_intrinsics__m512i, test_mm512_rem_epi64) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],rem((typename Vector8epi64::value_type)param_1[i], (typename Vector8epi64::value_type)param_2[i])) << "Input:"  << ";" <<param_1[i] << ";" <<param_2[i];
            }
}
...
TEST(SVML_intrinsics__m512i, test_mm512_rem_epu8) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],rem((typename Vector64epu8::value_type)param_1[i], (typename Vector64epu8::value_type)param_2[i])) << "Input:"  << ";" <<param_1[i] << ";" <<param_2[i];
            }
}
...
TEST(SVML_intrinsics__m512i, test_mm512_rem_epu16) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],rem((typename Vector32epu16::value_type)param_1[i], (typename Vector32epu16::value_type)param_2[i])) << "Input:"  << ";" <<param_1[i] << ";" <<param_2[i];
            }
}
...
TEST(SVML_intrinsics__m512i, test_mm512_rem_epu32) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],rem((typename Vector16epu32::value_type)param_1[i], (typename Vector16epu32::value_type)param_2[i])) << "Input:"  << ";" <<param_1[i] << ";" <<param_2[i];
            }
}
...
TEST(SVML_intrinsics__m512i, test_mm512_rem_epu64) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],rem((typename Vector8epu64::value_type)param_1[i], (typename Vector8epu64::value_type)param_2[i])) << "Input:"  << ";" <<param_1[i] << ";" <<param_2[i];
            }
}
...
TEST(SVML_intrinsics__m512, test_mm512_sin_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(sin((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],sin((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_sin_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(sin((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],sin((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_cos_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(cos((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],cos((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_cos_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(cos((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],cos((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_sincos_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(sincos((typename Vector16ps::value_type)param_2[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],sincos((typename Vector16ps::value_type)param_2[i])) << "Input:"  << ";" <<param_2[i];
        }
        if(std::isnan(param_1[i]))
            EXPECT_TRUE(std::isnan(sincos1((typename Vector16ps::value_type)param_2[i])));
        else {
            EXPECT_FLOAT_EQ(param_1[i],sincos1((typename Vector16ps::value_type)param_2[i])) << "Input:"  << ";" <<param_2[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_sincos_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(sincos((typename Vector8pd::value_type)param_2[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],sincos((typename Vector8pd::value_type)param_2[i])) << "Input:"  << ";" <<param_2[i];
        }
        if(std::isnan(param_1[i]))
            EXPECT_TRUE(std::isnan(sincos1((typename Vector8pd::value_type)param_2[i])));
        else {
            EXPECT_DOUBLE_EQ(param_1[i],sincos1((typename Vector8pd::value_type)param_2[i])) << "Input:"  << ";" <<param_2[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_tan_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(tan((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],tan((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_tan_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(tan((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],tan((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_asin_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(asin((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],asin((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_asin_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(asin((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],asin((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_acos_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(acos((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],acos((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_acos_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(acos((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],acos((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_atan_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(atan((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],atan((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_atan_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(atan((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],atan((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_atan2_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(atan2((typename Vector16ps::value_type)param_1[i], (typename Vector16ps::value_type)param_2[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],atan2((typename Vector16ps::value_type)param_1[i], (typename Vector16ps::value_type)param_2[i])) << "Input:"  << ";" <<param_1[i] << ";" <<param_2[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_atan2_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(atan2((typename Vector8pd::value_type)param_1[i], (typename Vector8pd::value_type)param_2[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],atan2((typename Vector8pd::value_type)param_1[i], (typename Vector8pd::value_type)param_2[i])) << "Input:"  << ";" <<param_1[i] << ";" <<param_2[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_sind_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(sind((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],sind((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_sind_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(sind((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],sind((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_cosd_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(cosd((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],cosd((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_cosd_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(cosd((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],cosd((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_tand_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(tand((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],tand((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_tand_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(tand((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],tand((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_sinh_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(sinh((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],sinh((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_sinh_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(sinh((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],sinh((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_cosh_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(cosh((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],cosh((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_cosh_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(cosh((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],cosh((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_tanh_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(tanh((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],tanh((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_tanh_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(tanh((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],tanh((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_asinh_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(asinh((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],asinh((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_asinh_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(asinh((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],asinh((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_acosh_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(acosh((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],acosh((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_acosh_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(acosh((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],acosh((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_atanh_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(atanh((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],atanh((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_atanh_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(atanh((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],atanh((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_log_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(log((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],log((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_log_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(log((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],log((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_log1p_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(log1p((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],log1p((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_log1p_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(log1p((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],log1p((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_log10_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(log10((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],log10((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_log10_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(log10((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],log10((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_log2_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(log2((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],log2((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_log2_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(log2((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],log2((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_logb_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(logb((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],logb((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_logb_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(logb((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],logb((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_exp_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(exp((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],exp((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_exp_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(exp((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],exp((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_exp10_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(exp10((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],exp10((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_exp10_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(exp10((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],exp10((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_exp2_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(exp2((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],exp2((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_exp2_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(exp2((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],exp2((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_expm1_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(expm1((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],expm1((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_expm1_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(expm1((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],expm1((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_pow_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(pow((typename Vector16ps::value_type)param_1[i], (typename Vector16ps::value_type)param_2[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],pow((typename Vector16ps::value_type)param_1[i], (typename Vector16ps::value_type)param_2[i])) << "Input:"  << ";" <<param_1[i] << ";" <<param_2[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_pow_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(pow((typename Vector8pd::value_type)param_1[i], (typename Vector8pd::value_type)param_2[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],pow((typename Vector8pd::value_type)param_1[i], (typename Vector8pd::value_type)param_2[i])) << "Input:"  << ";" <<param_1[i] << ";" <<param_2[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_trunc_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(trunc((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],trunc((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_trunc_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(trunc((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],trunc((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_svml_round_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(round((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],round((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_svml_round_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(round((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],round((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_fmod_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(fmod((typename Vector16ps::value_type)param_1[i], (typename Vector16ps::value_type)param_2[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],fmod((typename Vector16ps::value_type)param_1[i], (typename Vector16ps::value_type)param_2[i])) << "Input:"  << ";" <<param_1[i] << ";" <<param_2[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_fmod_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(fmod((typename Vector8pd::value_type)param_1[i], (typename Vector8pd::value_type)param_2[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],fmod((typename Vector8pd::value_type)param_1[i], (typename Vector8pd::value_type)param_2[i])) << "Input:"  << ";" <<param_1[i] << ";" <<param_2[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_rint_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(rint((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],rint((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_rint_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(rint((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],rint((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_invsqrt_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(1/sqrt((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],1/sqrt((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_invsqrt_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(1/sqrt((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],1/sqrt((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_cbrt_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(cbrt((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],cbrt((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_cbrt_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(cbrt((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],cbrt((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_invcbrt_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(1/cbrt((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],1/cbrt((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_invcbrt_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(1/cbrt((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],1/cbrt((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_hypot_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(hypot((typename Vector16ps::value_type)param_1[i], (typename Vector16ps::value_type)param_2[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],hypot((typename Vector16ps::value_type)param_1[i], (typename Vector16ps::value_type)param_2[i])) << "Input:"  << ";" <<param_1[i] << ";" <<param_2[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_hypot_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(hypot((typename Vector8pd::value_type)param_1[i], (typename Vector8pd::value_type)param_2[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],hypot((typename Vector8pd::value_type)param_1[i], (typename Vector8pd::value_type)param_2[i])) << "Input:"  << ";" <<param_1[i] << ";" <<param_2[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_cdfnorm_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(cdfnorm((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],cdfnorm((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_cdfnorm_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(cdfnorm((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],cdfnorm((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_cdfnorminv_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(1/cdfnorm((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],1/cdfnorm((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_mask_cdfnorminv_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(1/cdfnorm((typename Vector16ps::value_type)param_1[i], param_2 >>  i , (typename Vector16ps::value_type)param_3[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],1/cdfnorm((typename Vector16ps::value_type)param_1[i], param_2 >>  i , (typename Vector16ps::value_type)param_3[i])) << "Input:"  << ";" <<param_1[i] << ";" << ((param_2>> i) & 1) << ";" <<param_3[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_cdfnorminv_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(1/cdfnorm((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],1/cdfnorm((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_mask_cdfnorminv_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(1/cdfnorm((typename Vector8pd::value_type)param_1[i], param_2 >>  i , (typename Vector8pd::value_type)param_3[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],1/cdfnorm((typename Vector8pd::value_type)param_1[i], param_2 >>  i , (typename Vector8pd::value_type)param_3[i])) << "Input:"  << ";" <<param_1[i] << ";" << ((param_2>> i) & 1) << ";" <<param_3[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_erf_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(erf((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],erf((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_erf_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(erf((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],erf((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_erfc_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(erfc((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],erfc((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_erfc_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(erfc((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],erfc((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_erfcinv_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(1/erfc((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],1/erfc((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_mask_erfcinv_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(1/erfc((typename Vector16ps::value_type)param_1[i], param_2 >>  i , (typename Vector16ps::value_type)param_3[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],1/erfc((typename Vector16ps::value_type)param_1[i], param_2 >>  i , (typename Vector16ps::value_type)param_3[i])) << "Input:"  << ";" <<param_1[i] << ";" << ((param_2>> i) & 1) << ";" <<param_3[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_erfcinv_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(1/erfc((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],1/erfc((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_mask_erfcinv_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(1/erfc((typename Vector8pd::value_type)param_1[i], param_2 >>  i , (typename Vector8pd::value_type)param_3[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],1/erfc((typename Vector8pd::value_type)param_1[i], param_2 >>  i , (typename Vector8pd::value_type)param_3[i])) << "Input:"  << ";" <<param_1[i] << ";" << ((param_2>> i) & 1) << ";" <<param_3[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_erfinv_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(1/erf((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],1/erf((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_mask_erfinv_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(1/erf((typename Vector16ps::value_type)param_1[i], param_2 >>  i , (typename Vector16ps::value_type)param_3[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],1/erf((typename Vector16ps::value_type)param_1[i], param_2 >>  i , (typename Vector16ps::value_type)param_3[i])) << "Input:"  << ";" <<param_1[i] << ";" << ((param_2>> i) & 1) << ";" <<param_3[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_erfinv_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(1/erf((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],1/erf((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_mask_erfinv_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(1/erf((typename Vector8pd::value_type)param_1[i], param_2 >>  i , (typename Vector8pd::value_type)param_3[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],1/erf((typename Vector8pd::value_type)param_1[i], param_2 >>  i , (typename Vector8pd::value_type)param_3[i])) << "Input:"  << ";" <<param_1[i] << ";" << ((param_2>> i) & 1) << ";" <<param_3[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512, test_mm512_nearbyint_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(nearbyint((typename Vector16ps::value_type)param_1[i])));
        else {
            EXPECT_FLOAT_EQ(Result[i],nearbyint((typename Vector16ps::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
...
TEST(SVML_intrinsics__m512d, test_mm512_nearbyint_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        if(std::isnan(Result[i]))
            EXPECT_TRUE(std::isnan(nearbyint((typename Vector8pd::value_type)param_1[i])));
        else {
            EXPECT_DOUBLE_EQ(Result[i],nearbyint((typename Vector8pd::value_type)param_1[i])) << "Input:"  << ";" <<param_1[i];
        }
    }
}
