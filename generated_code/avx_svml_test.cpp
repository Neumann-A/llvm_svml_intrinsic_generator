...
{
    __m128i impl_param_0 = *(__m128i*) &param_0;
    __m128i impl_param_1 = *(__m128i*) &param_1;
...
TEST(SVML_intrinsics__m128i, test_mm_div_epi8) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],div((typename Vector16epi8::value_type)param_1[i], (typename Vector16epi8::value_type)param_2[i]).quot); 
    }
}
...
TEST(SVML_intrinsics__m128i, test_mm_div_epi16) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],div((typename Vector8epi16::value_type)param_1[i], (typename Vector8epi16::value_type)param_2[i]).quot); 
    }
}
...
TEST(SVML_intrinsics__m128i, test_mm_div_epi32) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],div((typename Vector4epi32::value_type)param_1[i], (typename Vector4epi32::value_type)param_2[i]).quot); 
    }
}
...
TEST(SVML_intrinsics__m128i, test_mm_div_epi64) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],div((typename Vector2epi64::value_type)param_1[i], (typename Vector2epi64::value_type)param_2[i]).quot); 
    }
}
...
TEST(SVML_intrinsics__m128i, test_mm_div_epu8) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],div((typename Vector16epu8::value_type)param_1[i], (typename Vector16epu8::value_type)param_2[i]).quot); 
    }
}
...
TEST(SVML_intrinsics__m128i, test_mm_div_epu16) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],div((typename Vector8epu16::value_type)param_1[i], (typename Vector8epu16::value_type)param_2[i]).quot); 
    }
}
...
TEST(SVML_intrinsics__m128i, test_mm_div_epu32) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],div((typename Vector4epu32::value_type)param_1[i], (typename Vector4epu32::value_type)param_2[i]).quot); 
    }
}
...
TEST(SVML_intrinsics__m128i, test_mm_div_epu64) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],div((typename Vector2epu64::value_type)param_1[i], (typename Vector2epu64::value_type)param_2[i]).quot); 
    }
}
...
TEST(SVML_intrinsics__m128i, test_mm_rem_epi8) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],rem((typename Vector16epi8::value_type)param_1[i], (typename Vector16epi8::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m128i, test_mm_rem_epi16) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],rem((typename Vector8epi16::value_type)param_1[i], (typename Vector8epi16::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m128i, test_mm_rem_epi32) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],rem((typename Vector4epi32::value_type)param_1[i], (typename Vector4epi32::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m128i, test_mm_rem_epi64) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],rem((typename Vector2epi64::value_type)param_1[i], (typename Vector2epi64::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m128i, test_mm_rem_epu8) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],rem((typename Vector16epu8::value_type)param_1[i], (typename Vector16epu8::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m128i, test_mm_rem_epu16) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],rem((typename Vector8epu16::value_type)param_1[i], (typename Vector8epu16::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m128i, test_mm_rem_epu32) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],rem((typename Vector4epu32::value_type)param_1[i], (typename Vector4epu32::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m128i, test_mm_rem_epu64) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],rem((typename Vector2epu64::value_type)param_1[i], (typename Vector2epu64::value_type)param_2[i])); 
    }
}
...
{
    __m256i impl_param_0 = *(__m256i*) &param_0;
    __m256i impl_param_1 = *(__m256i*) &param_1;
...
TEST(SVML_intrinsics__m256i, test_mm256_div_epi8) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],div((typename Vector32epi8::value_type)param_1[i], (typename Vector32epi8::value_type)param_2[i]).quot); 
    }
}
...
TEST(SVML_intrinsics__m256i, test_mm256_div_epi16) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],div((typename Vector16epi16::value_type)param_1[i], (typename Vector16epi16::value_type)param_2[i]).quot); 
    }
}
...
TEST(SVML_intrinsics__m256i, test_mm256_div_epi32) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],div((typename Vector8epi32::value_type)param_1[i], (typename Vector8epi32::value_type)param_2[i]).quot); 
    }
}
...
TEST(SVML_intrinsics__m256i, test_mm256_div_epi64) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],div((typename Vector4epi64::value_type)param_1[i], (typename Vector4epi64::value_type)param_2[i]).quot); 
    }
}
...
TEST(SVML_intrinsics__m256i, test_mm256_div_epu8) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],div((typename Vector32epu8::value_type)param_1[i], (typename Vector32epu8::value_type)param_2[i]).quot); 
    }
}
...
TEST(SVML_intrinsics__m256i, test_mm256_div_epu16) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],div((typename Vector16epu16::value_type)param_1[i], (typename Vector16epu16::value_type)param_2[i]).quot); 
    }
}
...
TEST(SVML_intrinsics__m256i, test_mm256_div_epu32) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],div((typename Vector8epu32::value_type)param_1[i], (typename Vector8epu32::value_type)param_2[i]).quot); 
    }
}
...
TEST(SVML_intrinsics__m256i, test_mm256_div_epu64) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],div((typename Vector4epu64::value_type)param_1[i], (typename Vector4epu64::value_type)param_2[i]).quot); 
    }
}
...
TEST(SVML_intrinsics__m256i, test_mm256_rem_epi8) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],rem((typename Vector32epi8::value_type)param_1[i], (typename Vector32epi8::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m256i, test_mm256_rem_epi16) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],rem((typename Vector16epi16::value_type)param_1[i], (typename Vector16epi16::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m256i, test_mm256_rem_epi32) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],rem((typename Vector8epi32::value_type)param_1[i], (typename Vector8epi32::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m256i, test_mm256_rem_epi64) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],rem((typename Vector4epi64::value_type)param_1[i], (typename Vector4epi64::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m256i, test_mm256_rem_epu8) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],rem((typename Vector32epu8::value_type)param_1[i], (typename Vector32epu8::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m256i, test_mm256_rem_epu16) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],rem((typename Vector16epu16::value_type)param_1[i], (typename Vector16epu16::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m256i, test_mm256_rem_epu32) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],rem((typename Vector8epu32::value_type)param_1[i], (typename Vector8epu32::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m256i, test_mm256_rem_epu64) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],rem((typename Vector4epu64::value_type)param_1[i], (typename Vector4epu64::value_type)param_2[i])); 
    }
}
...
__declspec(noinline) void helper__mm_divrem_epi32(Vector4epi32 &ret, Vector4epi32 &param_0, const Vector4epi32 &param_1, const Vector4epi32 &param_2)
{
    ...
    __m128i impl_param_1 = *(__m128i*) &param_1;
    __m128i impl_param_2 = *(__m128i*) &param_2;

    __m128i m_ret = _mm_divrem_epi32(&impl_param_0, impl_param_1, impl_param_2);

    *ret.data() =  *(std::decay_t<decltype(ret)>::value_type*)&m_ret;
    *param_0.data() = *(std::decay_t<decltype(param_0)>::value_type*)&impl_param_0;
...
TEST(SVML_intrinsics__m128i, test_mm_divrem_epi32) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],divrem((typename Vector4epi32::value_type)param_2[i], (typename Vector4epi32::value_type)param_3[i])); 
        EXPECT_EQ(param_1[i],divrem1((typename Vector4epi32::value_type)param_2[i], (typename Vector4epi32::value_type)param_3[i])); 
    }
}
...
TEST(SVML_intrinsics__m128i, test_mm_divrem_epu32) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],divrem((typename Vector4epu32::value_type)param_2[i], (typename Vector4epu32::value_type)param_3[i])); 
        EXPECT_EQ(param_1[i],divrem1((typename Vector4epu32::value_type)param_2[i], (typename Vector4epu32::value_type)param_3[i])); 
    }
}
...
__declspec(noinline) void helper__mm256_divrem_epi32(Vector8epi32 &ret, Vector8epi32 &param_0, const Vector8epi32 &param_1, const Vector8epi32 &param_2)
{
    ...
    __m256i impl_param_1 = *(__m256i*) &param_1;
    __m256i impl_param_2 = *(__m256i*) &param_2;
...
TEST(SVML_intrinsics__m256i, test_mm256_divrem_epi32) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],divrem((typename Vector8epi32::value_type)param_2[i], (typename Vector8epi32::value_type)param_3[i])); 
        EXPECT_EQ(param_1[i],divrem1((typename Vector8epi32::value_type)param_2[i], (typename Vector8epi32::value_type)param_3[i])); 
    }
}
...
TEST(SVML_intrinsics__m256i, test_mm256_divrem_epu32) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_EQ(Result[i],divrem((typename Vector8epu32::value_type)param_2[i], (typename Vector8epu32::value_type)param_3[i])); 
        EXPECT_EQ(param_1[i],divrem1((typename Vector8epu32::value_type)param_2[i], (typename Vector8epu32::value_type)param_3[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_sin_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],sin((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_sin_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],sin((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_sin_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],sin((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_sin_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],sin((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_cos_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],cos((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_cos_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],cos((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_cos_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],cos((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_cos_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],cos((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_sincos_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],sincos((typename Vector4ps::value_type)param_2[i])); 
        EXPECT_FLOAT_EQ(param_1[i],sincos1((typename Vector4ps::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_sincos_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],sincos((typename Vector2pd::value_type)param_2[i])); 
        EXPECT_DOUBLE_EQ(param_1[i],sincos1((typename Vector2pd::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_sincos_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],sincos((typename Vector8ps::value_type)param_2[i])); 
        EXPECT_FLOAT_EQ(param_1[i],sincos1((typename Vector8ps::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_sincos_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],sincos((typename Vector4pd::value_type)param_2[i])); 
        EXPECT_DOUBLE_EQ(param_1[i],sincos1((typename Vector4pd::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_tan_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],tan((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_tan_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],tan((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_tan_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],tan((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_tan_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],tan((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_asin_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],asin((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_asin_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],asin((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_asin_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],asin((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_asin_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],asin((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_acos_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],acos((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_acos_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],acos((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_acos_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],acos((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_acos_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],acos((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_atan_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],atan((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_atan_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],atan((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_atan_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],atan((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_atan_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],atan((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_atan2_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],atan2((typename Vector4ps::value_type)param_1[i], (typename Vector4ps::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_atan2_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],atan2((typename Vector2pd::value_type)param_1[i], (typename Vector2pd::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_atan2_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],atan2((typename Vector8ps::value_type)param_1[i], (typename Vector8ps::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_atan2_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],atan2((typename Vector4pd::value_type)param_1[i], (typename Vector4pd::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_sind_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],sind((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_sind_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],sind((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_sind_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],sind((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_sind_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],sind((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_cosd_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],cosd((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_cosd_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],cosd((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_cosd_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],cosd((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_cosd_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],cosd((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_tand_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],tand((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_tand_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],tand((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_tand_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],tand((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_tand_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],tand((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_sinh_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],sinh((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_sinh_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],sinh((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_sinh_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],sinh((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_sinh_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],sinh((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_cosh_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],cosh((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_cosh_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],cosh((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_cosh_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],cosh((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_cosh_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],cosh((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_tanh_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],tanh((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_tanh_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],tanh((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_tanh_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],tanh((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_tanh_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],tanh((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_asinh_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],asinh((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_asinh_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],asinh((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_asinh_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],asinh((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_asinh_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],asinh((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_acosh_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],acosh((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_acosh_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],acosh((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_acosh_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],acosh((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_acosh_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],acosh((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_atanh_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],atanh((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_atanh_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],atanh((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_atanh_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],atanh((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_atanh_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],atanh((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_log_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],log((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_log_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],log((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_log_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],log((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_log_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],log((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_log1p_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],log1p((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_log1p_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],log1p((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_log1p_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],log1p((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_log1p_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],log1p((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_log10_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],log10((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_log10_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],log10((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_log10_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],log10((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_log10_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],log10((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_log2_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],log2((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_log2_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],log2((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_log2_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],log2((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_log2_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],log2((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_logb_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],logb((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_logb_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],logb((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_logb_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],logb((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_logb_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],logb((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_exp_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],exp((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_exp_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],exp((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_exp_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],exp((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_exp_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],exp((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_exp10_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],exp10((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_exp10_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],exp10((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_exp10_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],exp10((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_exp10_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],exp10((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_exp2_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],exp2((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_exp2_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],exp2((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_exp2_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],exp2((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_exp2_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],exp2((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_expm1_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],expm1((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_expm1_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],expm1((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_expm1_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],expm1((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_expm1_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],expm1((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_pow_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],pow((typename Vector4ps::value_type)param_1[i], (typename Vector4ps::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_pow_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],pow((typename Vector2pd::value_type)param_1[i], (typename Vector2pd::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_pow_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],pow((typename Vector8ps::value_type)param_1[i], (typename Vector8ps::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_pow_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],pow((typename Vector4pd::value_type)param_1[i], (typename Vector4pd::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_trunc_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],trunc((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_trunc_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],trunc((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_trunc_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],trunc((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_trunc_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],trunc((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_svml_floor_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],floor((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_svml_floor_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],floor((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_svml_floor_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],floor((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_svml_floor_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],floor((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_svml_ceil_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],ceil((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_svml_ceil_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],ceil((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_svml_ceil_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],ceil((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_svml_ceil_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],ceil((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_svml_round_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],round((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_svml_round_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],round((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_svml_round_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],round((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_svml_round_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],round((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_fmod_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],fmod((typename Vector4ps::value_type)param_1[i], (typename Vector4ps::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_fmod_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],fmod((typename Vector2pd::value_type)param_1[i], (typename Vector2pd::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_fmod_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],fmod((typename Vector8ps::value_type)param_1[i], (typename Vector8ps::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_fmod_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],fmod((typename Vector4pd::value_type)param_1[i], (typename Vector4pd::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_svml_sqrt_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],sqrt((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_svml_sqrt_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],sqrt((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_svml_sqrt_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],sqrt((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_svml_sqrt_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],sqrt((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_invsqrt_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],1/sqrt((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_invsqrt_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],1/sqrt((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_invsqrt_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],1/sqrt((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_invsqrt_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],1/sqrt((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_cbrt_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],cbrt((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_cbrt_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],cbrt((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_cbrt_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],cbrt((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_cbrt_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],cbrt((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_invcbrt_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],1/cbrt((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_invcbrt_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],1/cbrt((typename Vector2pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_invcbrt_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],1/cbrt((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_invcbrt_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],1/cbrt((typename Vector4pd::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_hypot_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],hypot((typename Vector4ps::value_type)param_1[i], (typename Vector4ps::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m128d, test_mm_hypot_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],hypot((typename Vector2pd::value_type)param_1[i], (typename Vector2pd::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_hypot_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],hypot((typename Vector8ps::value_type)param_1[i], (typename Vector8ps::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m256d, test_mm256_hypot_pd) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_DOUBLE_EQ(Result[i],hypot((typename Vector4pd::value_type)param_1[i], (typename Vector4pd::value_type)param_2[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_cexp_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],cexp((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_cexp_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],cexp((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_clog_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],clog((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_clog_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],clog((typename Vector8ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m128, test_mm_csqrt_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],csqrt((typename Vector4ps::value_type)param_1[i])); 
    }
}
...
TEST(SVML_intrinsics__m256, test_mm256_csqrt_ps) {
    ...
    for(int i = 0; i < Result.size(); i++) {
        EXPECT_FLOAT_EQ(Result[i],csqrt((typename Vector8ps::value_type)param_1[i])); 
    }
}
